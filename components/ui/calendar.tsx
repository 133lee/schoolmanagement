...
function CalendarMonthsDropdown(props: any) {
  ...
  return (
    ...
    >
      <SelectTrigger className="h-8 w-[110px]">
        <SelectValue placeholder={options?.[month]?.label} />
      </SelectTrigger>
      <SelectContent>
...
function CalendarYearsDropdown(props: any) {
  const { value, onChange, options } = props
  const currentDate = value instanceof Date ? value : new Date()
