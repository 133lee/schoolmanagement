...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-4 px-4 pb-10 lg:px-0 lg:space-y-6">
      {/* ── Header — title/date hidden on mobile (top bar already shows
          "Dashboard"); term badge stays visible, pushed right via ml-auto
          since it's now the only child on mobile. ────────────────────── */}
      <div className="flex items-start justify-between gap-3 mt-5 lg:mt-1">
        ...
        {termBadge && (
          <Badge
            variant="secondary"
            className="text-xs lg:text-sm px-2 lg:px-3 py-1 lg:py-1.5 font-medium gap-1 lg:gap-1.5 mt-0.5 shrink-0 ml-auto lg:ml-0"
          >
